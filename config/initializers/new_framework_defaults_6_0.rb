...
# increased security.
#
# This option is not backwards compatible with earlier Rails versions. It's best
# enabled when your entire app is migrated and stable on 6.0.
...
# :active_storage_analysis Rails.application.config.active_storage.queues.purge
